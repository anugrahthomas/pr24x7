    ...
    <>
      ...
      >
        ...
        <div className="md:flex hidden gap-12 items-center font-semibold">
          <Link
            className={`hover:text-orange-400 transition-all duration-150 ease-in ${pathname === "/" ? "text-orange-400" : ""
              }`}
            to={"/"}
          >
            Home
          ...
          <Link
            className={`hover:text-orange-400 transition-all duration-150 ease-in ${pathname === "/about" ? "text-orange-400" : ""
              }`}
            to={"/about"}
          >
            About
          ...
          <Link
            className={`hover:text-orange-400 transition-all duration-150 ease-in ${pathname === "/services" ? "text-orange-400" : ""
              }`}
            to={"/services"}
          >
            Services
          ...
          <Link
            className={`hover:text-orange-400 transition-all duration-150 ease-in ${pathname === "/blog" ? "text-orange-400" : ""
              }`}
            to={"/blog"}
          >
            Blog
          ...
          <Link
            className={`hover:text-orange-400 transition-all duration-150 ease-in ${pathname === "/contact" ? "text-orange-400" : ""
              }`}
            to={"/contact"}
          >
            Contact
